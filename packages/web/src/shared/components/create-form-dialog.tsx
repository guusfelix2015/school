...
export const CreateFormDialog = ({ isOpen, onClose, onSubmit }: Props) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <Dialog open={isOpen} onClose={handleClose} className="relative z-50">
      ...
      <ModalWrapper size="small">
        <div className="p-4">
          <Dialog.Title className="mb-6 text-xl font-semibold">Novo Formulário</Dialog.Title>
